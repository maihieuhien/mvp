...
def parse_args():
    ...
    parser.add_argument("--model", help="Model Architecture", type=str, default = "bert-base-uncased", choices = ["distilbert/distilroberta-base","bert-base-uncased" ,"roberta-base", "gpt2"])
    ...
    #HPARAMS
    parser.add_argument("--differentiable_prompt",action='store_true')
    parser.add_argument("--use_mlm",action='store_true',help="Mask pertubation")
    parser.add_argument("--optim",help="Optimizer",type=str,default="adamw_torch", choices=["adamw_torch","SAM"])
