...
def trainer(args):
    ...
    # if args.use_mlm:
    #     print("***** Using mask pertubation *****")
    #     data_collator_at = DataCollatorAT(tokenizer=tokenizer,model_name=args.model)
    # else:
    data_collator_at = None
        
    model = get_model(args, tokenized_dataset, tokenizer, data_collator, data_collator_at = data_collator_at, verbalizer = verbalizer, template = templates)
    ...
    print(f"******* Logging and save per {interval} *******")
