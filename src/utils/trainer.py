...
class Trainer:
    ...
    def create_optimizer(self):
        ...
        if self.optimizer is None:
            ...
            print(f"Use {self.args.optim} optimizer")
            if self.args.optim == "SAM":
                from .sam import SAM
                from torch.optim import AdamW
                optimizer_cls, optimizer_kwargs = SAM, {"base_optimizer": AdamW,"rho":0.05,"lr":self.args.learning_rate}
            else:
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (
                    ...
                    if self.args.optim != "SAM":
                        ...
                        with self.accelerator.accumulate(model):
                            tr_loss_step = self.training_step(model, inputs)#, noise = True)
    ...
    def training_step(self, model: nn.Module, inputs: Dict[str, Union[torch.Tensor, Any]], noise: bool = False) -> torch.Tensor:
        """
